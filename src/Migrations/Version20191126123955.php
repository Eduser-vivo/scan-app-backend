 ...
 */
final class Version20191126123955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fiche ADD utilisateur_id INT NOT NULL, CHANGE montant montant INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fiche DROP utilisateur_id, CHANGE montant montant BIGINT NOT NULL');
    }
}
